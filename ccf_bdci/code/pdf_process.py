...
if __name__ == '__main__':
    pdf_path = r"/opt/kelvin/python/knowledge_graph/ai_contest/bdci_2024/A_document/AY03.pdf"
    in_dir = r"/bdci_2024/pdf_env/B_document"
    out_path = r"/bdci_2024/pdf_env/pdf_md_B"
    #prefix = "AY"
    #filters = ["AY01.pdf", "AY02.pdf", "AY03.pdf", "AY04.pdf", "AY05.pdf", "AY06.pdf"]
    #in_dir = r"/kaggle/working/B_document"
    #out_path = r"/kaggle/working/pdf_md"
    prefix = "B"
    filters = []
    ...
    for pdf_file in dir_files:
    	if pdf_file.startswith(prefix) and pdf_file not in filters:
    		pdf_file = os.path.join(in_dir, pdf_file)
    		print("================= start to process ===================")
    		print(pdf_file)
    		pdf_parse_main(pdf_path=pdf_file, output_dir=out_path)
    		count += 1

    print("total count: {}".format(count))
    #pdf_parse_main(pdf_path=pdf_path, output_dir=out_path)
